...
class _HomePageState extends State<HomePage> {
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        Text("Buenos Días,", style: TextStyles.title.subTitleColor),
        Text("Francisco Jorge", style: TextStyles.h1Style),
      ],
    ).p16;
  }
      ...
      children: <Widget>[
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text("Especialidades", style: TextStyles.title.bold),
              Text(
                "Ver Todas",
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _categoryCard("Médico General", "10 Doctores",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("Cardiólogo", "3 Doctores",
                  color: LightColor.skyBlue, lightColor: LightColor.lightBlue),
              _categoryCard("Oftalmólogo", "6 Doctores",
      ...
      delegate: SliverChildListDelegate(
        [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("Doctores más vistos", style: TextStyles.title.bold),
              IconButton(
                  icon: Icon(
                    Icons.sort,
